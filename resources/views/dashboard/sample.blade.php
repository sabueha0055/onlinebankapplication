        ...
        <nav class="navbar navbar-expand-lg main-navbar">
            ...
            <ul class="navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <img alt="image" style="width:100px" src="<?php echo $url.$user->image?>" class="rounded-circle mr-1">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="dropdown ">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="index-0.html">Add category</a></li>
                             <li><a class="nav-link" href="index-0.html">Edit category</a></li>
                            <li class=""><a class="nav-link" href="index-2.html">All Category</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="nav-link" href="layout-top-navigation.html">Edit Product</a></li>

                             <li><a class="nav-link" href="layout-top-navigation.html">View Products</a></li>
                        </ul>
                    </li>
                    <li><a class="nav-link" href="blank.html"><i class="far fa-square"></i> <span>Blank Page</span></a></li>
                    <li class="dropdown">
                        <a href="#" class="nav-link has-dropdown"><i class="fas fa-th"></i> <span>customer</span></a>
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="bootstrap-alert.html">Add Customer</a></li>
                            <li><a class="nav-link" href="bootstrap-badge.html">Edit Customer</a></li>
                            <li><a class="nav-link" href="bootstrap-breadcrumb.html">View Customer</a></li>
                            <li><a class="nav-link" href="bootstrap-buttons.html"></a></li>
                    ...
                    <li class="dropdown">
                        <a href="#" class="nav-link has-dropdown"><i class="fas fa-th-large"></i> <span>Customer</span></a>
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="components-article.html">Add Customer</a></li>
                            <li><a class="nav-link beep beep-sidebar" href="components-avatar.html">Edit Customer</a></li>
                            <li><a class="nav-link" href="components-chat-box.html">View Customer</a></li>
                            </ul>
                    </li>
                    <li class="dropdown">
...
<script src="{{('jscodepie/js/CodiePie.js')}}"></script>
...
<script src="{{('jscodepie/js/page/index.')}}'"></script>

<!-- Template JS File -->
<script src="{{asset('jscodepie/js/scripts.js')}}"></script>
<script src="{{asset('jscodepie/js/custom.js')}}"></script>
</body>

<!--   Tue, 07 Jan 2020 03:35:12 GMT -->
</html>public function creditall()
    {
      $creditall = User::get();
      var_dump($creditall);
